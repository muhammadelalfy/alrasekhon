...
class ArbitratorLevelRequest extends FormRequest
{
    ...
    {
        return [
            'name.ar' => __('arbitrator_levels.name_ar'),
            'name.en' => __('arbitrator_levels.name_en'),
            'description.ar' => __('arbitrator_levels.description_ar'),
            'description.en' => __('arbitrator_levels.description_en'),
        ];
    }
